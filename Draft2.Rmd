...
Let's see how this model performs on all the data!

```{r}
# Degree 3 was shown to be most effective
...
# Stepwise regression model
final_step_forwards.model <- stepAIC(final_combined.model, direction = "forward", 
                      trace = FALSE)
summary(final_step_forwards.model)
```
